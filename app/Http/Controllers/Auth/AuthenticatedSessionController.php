...
class AuthenticatedSessionController extends Controller
{
    ...
    public function showAffiliateLoginForm(): View
    {
     ...
     * Handle an incoming authentication request.
     */
    public function affiliateLogin(AffiliateLoginRequest $request): RedirectResponse
    {
        $request->authenticate();
     ...
     * Destroy an authenticated session.
     */
    public function affiliateDestroy(Request $request): RedirectResponse
    {
